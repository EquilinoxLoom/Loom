...
public class ParamRegistry {
    ...
    protected final LinkedHashMap<String, Class<?>> params = new LinkedHashMap<>();

    /** A map to store the names and types of parameters in the component class. */
    protected final LinkedHashMap<String, Class<?>> optionals = new LinkedHashMap<>();
    ...
    protected void addField(List<Field> fields, String name) {
        try {
