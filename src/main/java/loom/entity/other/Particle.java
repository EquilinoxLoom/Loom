...
public class Particle extends EntityComponent {
    ...
    public Particle(@NotNull SpawnPattern spawn, float particlesPerSecond, float speed, float gravity, float duration,
    ...
    public Particle(@NotNull Color color, boolean additive, float timeToFadeIn, float timeToFadeOut,
    ...
    public Particle setRandomRotation() {
        rotation = true;
        return this;
    }

    public Particle setRandomXRotationSpeed(float xRot) {
        rotation = true;
        xRotation = true;
        this.x3 = xRot;
        return this;
    ...
    public Particle setUpDown(float speed) {
        this.udSpeed = speed;
        return this;
    }
